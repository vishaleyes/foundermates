<div class="tab-content msgcontent tabcontentwidth" id="tab-content" style="margin-top: -60px !important; font-family:Helvetica, Arial, sans-serif;">
     ...
     <h3 align="left" style="margin-left:10px;">To, <?php echo $message['firstName']." ".$message['lastName'] ; ?></h3>
     <?php } else { 
     ...
     <?php } ?>	
        ...
        <div id="messageText">
         		<textarea disabled="disabled" style="margin-left:10px;"  class="txt" name="message" id="message"><?php echo htmlspecialchars_decode(html_entity_decode($message['message'])) ; ?></textarea>
                <br/><br/>
