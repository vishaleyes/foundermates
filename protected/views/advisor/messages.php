...
<section class="admincontent">	
   ...
   <div class="tab-wrapper">
      ...
      <form name="fact_form" id="fact_form" action="<?php echo Yii::app()->params->base_path; ?>advisor/SendInRecieverTrashMessages" method="post" onSubmit="return redirect();">
			 ...
			 ?>  
              <tr <?php if($i%2!=0){ ?> class="oddrow bigrow" <?php } else { ?>class="evenrow bigrow" <?php } ?> >
               <td><input type="checkbox" name="check" value="<?php echo $row['message_id'] ; ?>" onchange="check_uncheck();"></td>
                  <td style="cursor:pointer;" onclick="showMessage('<?php echo $row['message_id']; ?>');"  class="msgrow"><font class="mailername"><a style="color:#10BEF8;" href="<?php echo Yii::app()->params->base_path ?>advisor/showEntProfile/userId/<?php echo $alogObj->encrypt($row['sender_id'])  ; ?>" >
			  <?php echo $row['firstName'].' '.$row['lastName'] ; ?>
              </a></font><br /><?php echo $row['subject']; ?><br /><?php /*?><a href="#"><span>Reply</span></a>&nbsp;<a href="<?php echo Yii::app()->params->base_path;?>advisor/saveAsTrash/message_id/<?php echo $row['message_id'] ?>"><span>Trash</span></a><?php */?>
                  </td>
                  <td>
                   <?php 
