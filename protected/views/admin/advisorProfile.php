...
<center>
    ...
    padding-top: 5px;"><img src="<?php echo Yii::app()->params->base_url; ?>images/photo_icon.png" />Personal Details</h3>
		...
		{
			$filePath =  Yii::app()->params->base_url."timthumb/timthumb.php?src=".Yii::app()->params->base_url."assets/upload/avatar/". $profileData['avatar'] ."&h=100&w=100&q=60&zc=0";
		}
        ...
        <table style="margin:0px; margin-left:-40px; padding:5px; color:#666666;
	    	...
	    	<td align="left"><?php if(isset($profileData['phone'])) { echo $profileData['phone'] ; } else { echo "-NOT SET-"; } ?></td>
  			</tr>
        </table>
    ...
    <table border="0" style="margin:0px; padding:5px; color:#666666;
		...
		if(isset($profileData['stage'])) { 
         ...
         <tr>
            ...
            <td><?php if(isset($profileData['motivation'])) { echo $profileData['motivation'] ; } else { echo "-NOT SET-"; } ?></td>
        </tr>
        <tr>
        	<td><strong class="profilelbl">Where did you hear about us ? </strong>&nbsp;&nbsp;</td>
            <td><?php if(isset($profileData['hearabout'])) { echo $profileData['hearabout'] ; } else { echo "-NOT SET-"; } ?></td>
        </tr>
    </table>
	...
	foreach ($data['messages'] as $row) { ?>
        ...
        <?php } ?>
    		...
    		<td width="68%" align="left" style="color:#10BEF8; font-size:16px; vertical-align:top !important; height:5% !important"><a href="<?php echo $row['EntlinkedinLink'];?>" style="color:#10BEF8;" ><b><?php if(isset($row['EntFirstName'])) { echo $row['EntFirstName']." ".$row['EntLastName'] ; } else { echo "-NOT SET-"; } ?></b></a></td>
  			</tr>
  			<tr>
	    	<td align="left" style="width: 100%;min-width: 910px;text-align: justify; vertical-align:top !important;"><?php if(isset($row['expertise_area'])) { echo "I endorse advisor in : ".$row['expertise_area']; } else { echo ""; } ?><br/><?php if(isset($row['advisor_experience'])) { echo $row['advisor_experience']; } else { echo "-NOT SET-"; } ?>
            <br />
