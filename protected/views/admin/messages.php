                            ...
                            <div class="midr">
                                <div class="cont">   
                                    <div class="headingtop">
                                        <h1 style="margin-left:15px; background:none;">All Emails</h1>
                                    </div>
                                    <div class="contdiv">
 ...
 <table cellpadding="0" style="vertical-align:middle;" cellspacing="0" border="0" class="tableListing width700">
  <tr>
   <th  class="alignCenter">No</th>
    <th   class="alignCenter"><a href="<?php echo Yii::app()->params->base_path;?>admin/Emails/sortType/<?php echo $ext['sortType'];?>/sortBy/subject" class="sort">Subject<?php 
  if($ext['img_name'] != '' && $ext['sortBy'] == 'subject'){ ?>
  <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
 <?php } ?> </a></th>
  <th  class="alignCenter"><a href="<?php echo Yii::app()->params->base_path;?>admin/Emails/sortType/<?php echo $ext['sortType'];?>/sortBy/message" class="sort">Message<?php 
  if($ext['img_name'] != '' && $ext['sortBy'] == 'message'){ ?>
  <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
 <?php } ?> </a></th>
  <th class="alignCenter"><a href="<?php echo Yii::app()->params->base_path;?>admin/Emails/sortType/<?php echo $ext['sortType'];?>/sortBy/sender_id" class="sort">Sender<?php 
  if($ext['img_name'] != '' && $ext['sortBy'] == 'sender_id'){ ?>
  <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
 <?php } ?> </a></th> 
    <th  class="alignCenter"><a href="<?php echo Yii::app()->params->base_path;?>admin/Emails/sortType/<?php echo $ext['sortType'];?>/sortBy/receiver_id" class="sort">Receiver<?php 
  if($ext['img_name'] != '' && $ext['sortBy'] == 'receiver_id'){ ?>
  <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
 <?php } ?> </a></th>
			<th   class="alignCenter"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/Emails/sortType/<?php echo $ext['sortType'];?>/sortBy/messages.status' >Status<?php 
				if($ext['img_name'] != '' && $ext['sortBy'] == 'messages.status'){ ?>
					<img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
					<?php
				} ?>
				</a></th>
			<th   class="alignCenter"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/Emails/sortType/<?php echo $ext['sortType'];?>/sortBy/messages.createdAt' >CreatedAt<?php 
...
echo $i+($data['pagination']->getCurrentPage()*$data['pagination']->getLimit());
     ...
     <td  style="text-align:left" ><?php echo $row['subject'];?></td>
           <td  style="text-align:left" ><?php echo htmlspecialchars_decode(html_entity_decode($row['message']));?></td>
		   <td  style="text-align:left"><?php echo $row['sender'];?></td>
		   <td style="text-align:left"><?php echo $row['receiver'];?></td>
		   <td style="text-align:right"><?php echo $row['status'];?></td>
           ...
           <?php
			...
			{
		   ?>
 <a href="<?php echo Yii::app()->params->base_path;?>admin/deleteMessages/id/<?php echo $row['message_id'];?>" title="Delete"><img src="<?php echo Yii::app()->params->base_url; ?>images/error-icon.png"/> </a>
		<?php } else { ?>
