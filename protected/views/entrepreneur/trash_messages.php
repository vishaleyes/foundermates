...
<section class="admincontent">	
   ...
   <div class="composebg">
     ...
     <form name="fact_form" id="fact_form" action="<?php echo Yii::app()->params->base_path; ?>entrepreneur/removeFromTrash" method="post" onSubmit="return redirect();">
              ...
              <tr <?php if($i%2!=0){ ?> class="oddrow bigrow" <?php } else { ?>class="evenrow bigrow" <?php } ?> >
               <td><input type="checkbox" name="check" value="<?php echo $row['message_id'] ; ?>" onchange="check_uncheck();"></td>
                 ...
                 <?php if(Yii::app()->session['fmuserId'] != $row['sender_id']) { ?> 
                 	<font class="mailername"><a style="color:#10BEF8;" href="<?php echo Yii::app()->params->base_path ?>entrepreneur/showAdvisorProfile/userId/<?php echo $alogObj->encrypt($row['sender_id'])  ; ?>" >
