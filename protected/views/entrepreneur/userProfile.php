...
<input type="button" onclick="window.location.href='<?php echo Yii::app()->params->base_path;?>entrepreneur/userProfileAjax'" class="btnblue" value="Edit" />
</div>
