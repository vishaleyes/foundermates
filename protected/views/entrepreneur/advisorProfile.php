...
<h2>Advisor Profile</h2>
 ...
 <div class="ratingadvisor" style="width:123px !important; margin-top:-70px !important; height:35px !important; margin-left:145px !important;">
<a href="<?php echo Yii::app()->params->base_path;?>entrepreneur/requestAdvice/userId/<?php echo $_GET['userId'];?>/firstName/<?php echo $profileData['firstName']; ?>/lastName/<?php echo $profileData['lastName']; ?>"><span>Request Advice</span></a>
</div>
