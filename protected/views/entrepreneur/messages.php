...
<section class="admincontent">	
   ...
   <div class="composebg">
      ...
      <form name="fact_form" id="fact_form" action="<?php echo Yii::app()->params->base_path; ?>entrepreneur/SendInRecieverTrashMessages" method="post" onSubmit="return redirect();">
    ...
    text-decoration: none;" />
            ...
            <th></th>
            <th><!--<div class="dropdown" id="dropdown">
            <input type="checkbox" id="drop1" />
            <label for="drop1" class="dropdown_button">All Message <span class="arrow"></span></label>
			 ...
			 ?>  
              <tr <?php if($i%2!=0){ ?> class="oddrow bigrow" <?php } else { ?>class="evenrow bigrow" <?php } ?> >
               <td><input type="checkbox" name="check" value="<?php echo $row['message_id'] ; ?>" onchange="check_uncheck();"></td>
                  <td style="cursor:pointer;" onclick="showMessage('<?php echo $row['message_id']; ?>');"  class="msgrow"><font class="mailername"><a style="color:#10BEF8;" href="<?php echo Yii::app()->params->base_path ?>entrepreneur/showAdvisorProfile/userId/<?php echo $alogObj->encrypt($row['sender_id'])  ; ?>" >
			  <?php echo $row['firstName'].' '.$row['lastName'] ; ?>
              </a></font><br /><?php echo $row['subject']; ?><br /><?php /*?><a href="#"><span>Reply</span></a>&nbsp;<a href="<?php echo Yii::app()->params->base_path;?>entrepreneur/saveAsRecieverTrash/message_id/<?php echo $row['message_id'] ?>"><span>Delete</span></a><?php */?>
                  </td>
              ...
              <?php $i++; } } else { ?>  
  			<tr class="evenrow bigrow"  style="text-align:center;"><td colspan="3" style="color:#10BEF8 !important;">Your Inbox is Empty.</td></tr>				     
      <?php } ?>
          </table>
